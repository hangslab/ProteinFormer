...
def _resnet(arch, block, layers, pretrained, progress, in_c=3, **kwargs):
    model = ResNet(block, layers, in_c=in_c, **kwargs)
    if pretrained:
        print('state_dict from url')
...
def resnet50(in_c=3, pretrained=False, progress=True, **kwargs):
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet('resnet50', Bottleneck, [3, 4, 6, 3], pretrained, progress, in_c=in_c,
                   **kwargs)
